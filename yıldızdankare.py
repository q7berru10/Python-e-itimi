...
</style><script type="text/javascript" async="" src="./yıldızdankare_files/recaptcha__tr.js.indir" crossorigin="anonymous" integrity="sha384-AF2l+F3mJe9pOOcbupamxp/xzoMYVJZGnVvNfpIIo6yaxUd8Omgn8oRk4gQocNwX" nonce=""></script><script type="text/javascript" async="" src="./yıldızdankare_files/recaptcha__tr.js.indir" crossorigin="anonymous" integrity="sha384-AF2l+F3mJe9pOOcbupamxp/xzoMYVJZGnVvNfpIIo6yaxUd8Omgn8oRk4gQocNwX" nonce=""></script><script type="text/javascript" async="" src="./yıldızdankare_files/js" nonce=""></script><script src="./yıldızdankare_files/cb=gapi.loaded_1" nonce="" async=""></script><script src="./yıldızdankare_files/cb=gapi.loaded_0" nonce="" async=""></script><script async="" src="./yıldızdankare_files/analytics.js.indir"></script><script nonce="">
...
</custom-style><style>[hidden] { display: none !important; }</style><link rel="stylesheet" href="./yıldızdankare_files/css(1)"><link rel="stylesheet" href="./yıldızdankare_files/css(2)"><custom-style>
  <style is="custom-style">html {
...
html[editor=Synthwave84] {
  ...
  </custom-style><script async="async" type="text/javascript" src="./yıldızdankare_files/editor.main.js.indir"></script><script async="" type="text/javascript" charset="UTF-8" src="./yıldızdankare_files/rs=AA2YrTvLnSTmjOk117_e95V0EKaPsslVbQ" nonce=""></script><link type="text/css" rel="stylesheet" href="./yıldızdankare_files/rs=AA2YrTtRVVd7Ifu6yXdUSAZNCo3PPUxNcQ"><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="./yıldızdankare_files/editor.main.css"><script async="async" type="text/javascript" src="./yıldızdankare_files/editor.main.nls.js.indir"></script><style type="text/css">.MathJax_Hover_Frame {border-radius: .25em; -webkit-border-radius: .25em; -moz-border-radius: .25em; -khtml-border-radius: .25em; box-shadow: 0px 0px 15px #83A; -webkit-box-shadow: 0px 0px 15px #83A; -moz-box-shadow: 0px 0px 15px #83A; -khtml-box-shadow: 0px 0px 15px #83A; border: 1px solid #A6D ! important; display: inline-block; position: absolute}
...
</style><script async="async" type="text/javascript" src="./yıldızdankare_files/markdown.js.indir"></script><script src="./yıldızdankare_files/api.js.indir" nonce=""></script><script src="./yıldızdankare_files/api(1).js.indir" nonce=""></script><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
Ctrl+Alt+M" command="add-comment" role="button" aria-disabled="false" tabindex="0" style="display: none;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
:host([hidden]) {
  display: none;
        ...
        </paper-icon-button><!----><!----> <paper-icon-button class="colab-icon" noink="" icon="icons:settings" title="Düzenleyici ayarlarını aç" command="editor-preferences" role="button" aria-disabled="false" tabindex="0" style="display: none;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
:host([hidden]) {
  display: none;
        ...
        </paper-icon-button><!----><!----> <paper-icon-button class="colab-icon" noink="" icon="colab:mirror-cell" title="Hücreyi sekmeye yansıt" command="mirror-cell-in-tab" role="button" aria-disabled="false" tabindex="0" style="display: none;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
yürütme, gizem arslan tarafından gerçekleştirildi
16:02 (22 saat önce)
0.319 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale hovered">
      <div class="execution-count"><!--?lit$5833163945$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$5833163945$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$5833163945$-->
...
:host([hidden]) {
  display: none;
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;random&nbsp;</span><span class="mtk19">as</span><span class="mtk1">&nbsp;rd</span></span><br><span><span class="mtk1">rastgele=rd.randint(</span><span class="mtk12">1</span><span class="mtk1">,</span><span class="mtk12">50</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
...
:host([hidden]) {
  display: none;
    ...
    <div class="layout vertical grow tab-pane-container"> </div>
        ...
        <div class="proxies"><div><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yıldızdankare_files/outputframe.html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div><div><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="accelerometer; autoplay; camera; gyroscope; magnetometer; microphone; serial; usb; xr-spatial-tracking; clipboard-write" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-modals allow-popups-to-escape-sandbox" src="./yıldızdankare_files/outputframe(1).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div></div>
...
:host([hidden]) {
  display: none;
      ...
      </div></div><div class="thumbnail"></div><iframe id="apiproxy5eb495b9718564b9494d5eb929c80d6b1c2fedff0.3026357389" name="apiproxy5eb495b9718564b9494d5eb929c80d6b1c2fedff0.3026357389" src="./yıldızdankare_files/proxy.html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px; display: none;"></iframe><div class="monaco-aria-container"><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div></div><div><div class="grecaptcha-badge" data-style="bottomright" style="width: 256px; height: 60px; position: fixed; visibility: hidden; display: block; transition: right 0.3s ease 0s; bottom: 14px; right: -186px; box-shadow: gray 0px 0px 5px; border-radius: 2px; overflow: hidden;"><div class="grecaptcha-logo"><iframe title="reCAPTCHA" width="256" height="60" role="presentation" name="a-nzwrz2amvb4z" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="./yıldızdankare_files/anchor.html"></iframe></div><div class="grecaptcha-error"></div><textarea id="g-recaptcha-response-100000" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./yıldızdankare_files/saved_resource(1).html"></iframe></div><iframe id="apiproxyb66848ecd7c3e55eb861f491bca2131c05cb76220.2135591338" name="apiproxyb66848ecd7c3e55eb861f491bca2131c05cb76220.2135591338" src="./yıldızdankare_files/proxy(1).html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px; display: none;"></iframe><iframe id="hfcr" src="./yıldızdankare_files/RotateCookiesPage.html" style="display: none;"></iframe><iframe src="./yıldızdankare_files/bscframe.html" style="display: none;"></iframe><script src="./yıldızdankare_files/chat_load.js.indir" nonce="" gapi_processed="true"></script><div id="roster-for-Google-Help" style="display: none;"></div><iron-a11y-announcer><template shadowrootmode="open"><style scope="iron-a11y-announcer">:host {
  display: inline-block;
        position: fixed;
