<!DOCTYPE html>
<!-- saved from url=(0073)https://colab.research.google.com/drive/1Edm3snX_fmaSfw4L3ev9KwwuOAOT32HR -->
...
</custom-style><style>[hidden] { display: none !important; }</style><link rel="stylesheet" href="./yılbasıyıldızlı_files/css(1)"><link rel="stylesheet" href="./yılbasıyıldızlı_files/css(2)"><custom-style>
  <style is="custom-style">html {
...
<svg>
  <defs>
    ...
    <g id="copy-to-scratch">
      <!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
...
html[editor=Synthwave84] {
  ...
  </custom-style><script async="async" type="text/javascript" src="./yılbasıyıldızlı_files/editor.main.js.indir"></script><script async="" type="text/javascript" charset="UTF-8" src="./yılbasıyıldızlı_files/rs=AA2YrTvLnSTmjOk117_e95V0EKaPsslVbQ" nonce=""></script><link type="text/css" rel="stylesheet" href="./yılbasıyıldızlı_files/rs=AA2YrTtRVVd7Ifu6yXdUSAZNCo3PPUxNcQ"><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="./yılbasıyıldızlı_files/editor.main.css"><script async="async" type="text/javascript" src="./yılbasıyıldızlı_files/editor.main.nls.js.indir"></script><style type="text/css">.MathJax_Hover_Frame {border-radius: .25em; -webkit-border-radius: .25em; -moz-border-radius: .25em; -khtml-border-radius: .25em; box-shadow: 0px 0px 15px #83A; -webkit-box-shadow: 0px 0px 15px #83A; -moz-box-shadow: 0px 0px 15px #83A; -khtml-box-shadow: 0px 0px 15px #83A; border: 1px solid #A6D ! important; display: inline-block; position: absolute}
...
</style><script src="./yılbasıyıldızlı_files/api.js.indir" nonce=""></script><script src="./yılbasıyıldızlı_files/api(1).js.indir" nonce=""></script><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
// Google Inc.
</script><div style="position: absolute; width: 0px; height: 0px; overflow: hidden; padding: 0px; border: 0px; margin: 0px;"><div id="MathJax_Font_Test" style="position: absolute; visibility: hidden; top: 0px; left: 0px; width: auto; min-width: 0px; max-width: none; padding: 0px; border: 0px; margin: 0px; white-space: nowrap; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal; font-size: 40px; font-weight: normal; font-style: normal; font-family: MathJax_Size1, monospace;"></div></div><iframe id="hfcr" src="./yılbasıyıldızlı_files/RotateCookiesPage.html" style="display: none;"></iframe><div class="notebook-vertical" style="position: relative;">
      <div class="top-floater"><div role="banner">
    <colab-header-skip-button><template shadowrootmode="open"><!----><a id="skiplink" class="skip-link" href="https://colab.research.google.com/drive/1Edm3snX_fmaSfw4L3ev9KwwuOAOT32HR#top-toolbar"><!--?lit$111755957$-->Ana içeriğe atla</a></template></colab-header-skip-button>
    <!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <!--?lit$111755957$-->
          <div id="private-outputs-warning" class="header-warning private-outputs-warning hidden">
            <!--?lit$111755957$-->Bu not defteri, özel çıkışlarla açılmış durumda. Çıkışlar kaydedilmeyecek. Bu özelliği <a href="https://colab.research.google.com/drive/1Edm3snX_fmaSfw4L3ev9KwwuOAOT32HR#" id="private-outputs-notebook-info-link" command="notebook-settings" aria-describedby="private-outputs-notebook-info-link-tooltip">Not defteri ayarları</a><colab-tooltip-trigger aria-hidden="true" for="private-outputs-notebook-info-link" id="private-outputs-notebook-info-link-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Not defteri ayarlarını aç</div><!----><!--?--></template>
        </colab-tooltip-trigger>'ndan devre dışı bırakabilirsiniz.
          <mwc-icon-button class="close" icon="close" title="Kapat"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Kapat"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->close</i>
    <span><slot></slot></span>
    ...
    <div id="header" class="horizontal layout">
      ...
      <div id="header-content">
        <!--?lit$111755957$-->
        <!--?lit$111755957$--><div id="header-logo">
              <!--?lit$111755957$--> <!--?lit$111755957$--><a href="https://drive.google.com/drive/search?q=owner%3Ame%20(type%3Aapplication%2Fvnd.google.colaboratory%20%7C%7C%20type%3Aapplication%2Fvnd.google.colab)&amp;authuser=0" aria-label="Google Drive&#39;da görüntüle">
        <!--?lit$111755957$--><md-icon class="colab-large-icon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
      <g id="colab-logo">
        ...
        <div id="header-doc-toolbar" class="flex">
          <div id="document-info">
            <!--?lit$111755957$--> <!--?lit$111755957$--><md-icon class="file-location-icon" id="file-type" aria-hidden="true" title="Not defteri, Google Drive&#39;da kayıtlı"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->
    ...
    <input id="doc-name" class="doc-name" maxlength="259" autocomplete="off" aria-label="Not defteri adı" command="rename" aria-describedby="doc-name-tooltip" style="width: 139.77px;"><colab-tooltip-trigger aria-hidden="true" for="doc-name" id="doc-name-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Not defterini yeniden adlandır</div><!----><!--?--></template>
        </colab-tooltip-trigger><colab-input-sizer aria-hidden="true" style="left: -1000%; position: absolute; font-family: &quot;Google Sans&quot;, Roboto, Noto, sans-serif; font-size: 18px; font-weight: 400; letter-spacing: normal; padding-left: 3px; padding-right: 4px; white-space: pre;">Untitled22.ipynb_</colab-input-sizer>
            <!--?lit$111755957$-->
                  <div class="screenreader-only" id="star-status" aria-live="polite">Not defterinden yıldız kaldırıldı</div>
                  <mwc-icon-button id="star-icon" command="toggle-star" aria-describedby="star-icon-tooltip"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Yıldız"><!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <span><slot></slot></span>
  </button></template>
                    <md-icon aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template>star</md-icon>
                  </mwc-icon-button><colab-tooltip-trigger aria-hidden="true" for="star-icon" id="star-icon-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Google Drive'da not defterine yıldız ekle</div><!----><!--?--></template>
        </colab-tooltip-trigger>
                
          </div>
        <div class="menubar-wrapper"><div><!----><div id="top-menubar" class="goog-menubar format-lightborder" role="menubar" tabindex="0" style="user-select: none;"><!--?lit$111755957$--><div class="goog-menu-button goog-inline-block" id="file-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Dosya</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="edit-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Düzenle</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="view-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Göster</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="insert-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Ekle</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="runtime-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Çalışma zamanı</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="tools-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Araçlar</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="help-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$111755957$-->Yardım</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div></div>
    <div id="colab-menu-cover" style="display: none;"> </div></div><!----><colab-last-saved-indicator aria-live="polite" aria-atomic="true" title=""><template shadowrootmode="open"><!----><button class=" save-message "><!--?lit$111755957$-->Son kaydedilme tarihi: 28 Ocak</button></template></colab-last-saved-indicator></div></div>
        <div id="header-right">
          <!--?lit$111755957$-->
    <colab-collaborator-bar id="collaborator-bar"><template shadowrootmode="open"><!----> <div class="collaborator-bar">
      ...
      <!--?lit$111755957$-->
          ...
          <!--?lit$111755957$--> <paper-button id="comments" command="open-comments-thread" role="button" tabindex="0" animated="" elevation="0" aria-disabled="false" aria-describedby="comments-tooltip"><template shadowrootmode="open"><style scope="paper-button">:host, html {
...
paper-ripple {
  color: var(--paper-button-ink-color);
                ...
                <span> <!--?lit$111755957$-->Yorum </span>
              </paper-button><colab-tooltip-trigger aria-hidden="true" for="comments" id="comments-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Yorum bölmesini aç</div><!----><!--?--></template>
        </colab-tooltip-trigger>
          <!--?lit$111755957$--> <paper-button id="share-toolbar-button" command="share" role="button" tabindex="0" animated="" elevation="0" aria-disabled="false" aria-describedby="share-toolbar-button-tooltip"><template shadowrootmode="open"><style scope="paper-button">:host, html {
  --paper-material_-_display:  block; --paper-material_-_position:  relative;;
        --paper-material-elevation-1_-_box-shadow:  var(--shadow-elevation-2dp_-_box-shadow);;
        --paper-material-elevation-2_-_box-shadow:  var(--shadow-elevation-4dp_-_box-shadow);;
        --paper-material-elevation-3_-_box-shadow:  var(--shadow-elevation-6dp_-_box-shadow);;
...
paper-ripple {
  color: var(--paper-button-ink-color);
                ...
                <md-icon aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->people</md-icon>
                <span> <!--?lit$111755957$-->Paylaş </span>
              </paper-button><colab-tooltip-trigger aria-hidden="true" for="share-toolbar-button" id="share-toolbar-button-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Not defterini paylaş</div><!----><!--?--></template>
        </colab-tooltip-trigger>
          <!--?lit$111755957$--> <mwc-icon-button id="settings-cog" command="preferences" title="Ayarları aç"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Ayarları aç"><!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <span><slot></slot></span>
  </button></template>
...
// Google Inc.
        ...
        <!--?lit$111755957$--><colab-left-pane role="complementary" aria-label="left pane"><!----><div class="colab-left-pane-nib layout vertical" role="toolbar" aria-orientation="vertical">
        <div class="left-pane-top"><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button-toggle command="show-toc-pane" title="İçindekiler"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex   " aria-pressed="false" aria-label="İçindekiler"><!--?lit$111755957$-->
        <span class="mdc-icon-button__icon"><slot name="offIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
        <span class="mdc-icon-button__icon mdc-icon-button__icon--on"><slot name="onIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
      </button></template>
          <md-icon slot="offIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->format_list_bulleted</md-icon>
          <md-icon slot="onIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->format_list_bulleted</md-icon>
        </mwc-icon-button-toggle> <!--?lit$111755957$-->
      </div><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button-toggle command="find" title="Bul ve değiştir"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex   " aria-pressed="false" aria-label="Bul ve değiştir"><!--?lit$111755957$-->
        <span class="mdc-icon-button__icon"><slot name="offIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
        <span class="mdc-icon-button__icon mdc-icon-button__icon--on"><slot name="onIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
      </button></template>
          <md-icon slot="offIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->search</md-icon>
          <md-icon slot="onIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->search</md-icon>
        </mwc-icon-button-toggle> <!--?lit$111755957$-->
      </div><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button-toggle command="show-variables" title="Değişkenler"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex   " aria-pressed="false" aria-label="Değişkenler"><!--?lit$111755957$-->
        <span class="mdc-icon-button__icon"><slot name="offIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
        <span class="mdc-icon-button__icon mdc-icon-button__icon--on"><slot name="onIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
      </button></template>
          <md-icon slot="offIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
      ...
      <path d="M15.16,8.22a.88.88,0,0,1,.46.16,1.25,1.25,0,0,0,.69.2h0A1,1,0,0,0,17,8.23a1.06,1.06,0,0,0,.24-.8,1.1,1.1,0,0,0-1.15-1h0c-1,0-1.73.64-3,2.57l-.12-.51c-.28-1.36-.56-2-1.39-2h0A8,8,0,0,0,9,7.08l-.47.16.16.91L9.41,8a3.22,3.22,0,0,1,.73-.14c.34,0,.43,0,.71,1.2l.56,2.47L9.76,13.82a3.6,3.6,0,0,1-.8.88.9.9,0,0,1-.38-.13,1.83,1.83,0,0,0-.88-.28,1,1,0,0,0-1,1.06A1.15,1.15,0,0,0,8,16.53c.85,0,1.35-.35,2.24-1.55l1.49-2,.46,1.88c.23,1,.46,1.66,1.53,1.66s1.66-.75,2.81-2.53l.17-.26-.81-.48-.16.2-.25.34-.19.25c-.45.57-.62.73-.76.73s-.28-.4-.34-.63l-.67-2.83a4.2,4.2,0,0,1-.15-.79C13.84,9.78,14.74,8.22,15.16,8.22Z"></path></svg></md-icon>
          <md-icon slot="onIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
      <path d="M4.51,9.44V6.08c0-1.34.37-1.85,1.6-2.17l.22-.06V3.13l-.27,0-.44,0a4.46,4.46,0,0,0-2.2.59,2.78,2.78,0,0,0-1,2.51V9.74c0,1.26-.26,1.61-1.49,2L0,12l.94.29c1.21.38,1.49.75,1.49,2v3.5a2.94,2.94,0,0,0,1,2.6,4.39,4.39,0,0,0,2.14.56l.46,0,.27,0v-.72l-.22-.06c-1.24-.32-1.6-.81-1.6-2.17V14.58c0-1.43-.3-2.13-1.25-2.57C4.2,11.57,4.51,10.87,4.51,9.44Z"></path>
      <path d="M23.06,11.71c-1.22-.36-1.49-.71-1.49-2l0-3.5a3,3,0,0,0-1-2.6,4.38,4.38,0,0,0-2.14-.56l-.46,0-.27,0v.72l.22.06c1.24.32,1.6.81,1.6,2.17V9.44c0,1.44.3,2.13,1.25,2.57-1,.44-1.25,1.14-1.25,2.57v3.36c0,1.34-.37,1.85-1.6,2.17l-.22.06v.72l.27,0,.44,0a4.47,4.47,0,0,0,2.2-.59,2.82,2.82,0,0,0,1-2.51V14.28c0-1.26.26-1.61,1.49-2L24,12Z"></path>
      <path d="M15.16,8.22a.88.88,0,0,1,.46.16,1.25,1.25,0,0,0,.69.2h0A1,1,0,0,0,17,8.23a1.06,1.06,0,0,0,.24-.8,1.1,1.1,0,0,0-1.15-1h0c-1,0-1.73.64-3,2.57l-.12-.51c-.28-1.36-.56-2-1.39-2h0A8,8,0,0,0,9,7.08l-.47.16.16.91L9.41,8a3.22,3.22,0,0,1,.73-.14c.34,0,.43,0,.71,1.2l.56,2.47L9.76,13.82a3.6,3.6,0,0,1-.8.88.9.9,0,0,1-.38-.13,1.83,1.83,0,0,0-.88-.28,1,1,0,0,0-1,1.06A1.15,1.15,0,0,0,8,16.53c.85,0,1.35-.35,2.24-1.55l1.49-2,.46,1.88c.23,1,.46,1.66,1.53,1.66s1.66-.75,2.81-2.53l.17-.26-.81-.48-.16.2-.25.34-.19.25c-.45.57-.62.73-.76.73s-.28-.4-.34-.63l-.67-2.83a4.2,4.2,0,0,1-.15-.79C13.84,9.78,14.74,8.22,15.16,8.22Z"></path></svg></md-icon>
        </mwc-icon-button-toggle> <!--?lit$111755957$-->
      </div><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button-toggle command="open-user-secrets" title="Gizli Anahtarlar"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex   " aria-pressed="false" aria-label="Gizli Anahtarlar"><!--?lit$111755957$-->
        <span class="mdc-icon-button__icon"><slot name="offIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
        <span class="mdc-icon-button__icon mdc-icon-button__icon--on"><slot name="onIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
      </button></template>
          <md-icon slot="offIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->vpn_key</md-icon>
          <md-icon slot="onIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->vpn_key</md-icon>
        </mwc-icon-button-toggle> <!--?lit$111755957$-->
      </div><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button-toggle command="show-files" title="Dosyalar"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex   " aria-pressed="false" aria-label="Dosyalar"><!--?lit$111755957$-->
        <span class="mdc-icon-button__icon"><slot name="offIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
        <span class="mdc-icon-button__icon mdc-icon-button__icon--on"><slot name="onIcon"><i class="material-icons"><!--?lit$111755957$--></i></slot></span>
      </button></template>
          <md-icon slot="offIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->folder</md-icon>
          <md-icon slot="onIcon" aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->folder</md-icon>
        </mwc-icon-button-toggle> <!--?lit$111755957$-->
      </div></div>
        <div class="left-pane-bottom"><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button command="snippets" title="Kod snippet&#39;leri"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Kod snippet&#39;leri"><!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <span><slot></slot></span>
  </button></template>
          <md-icon aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->code</md-icon>
        </mwc-icon-button> <!--?lit$111755957$-->
      </div><!----><div class="left-pane-button">
        <!--?lit$111755957$--><mwc-icon-button command="show-command-palette" title="Komut paleti"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Komut paleti"><!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <span><slot></slot></span>
  </button></template>
          <md-icon aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
      <path d="M21,3H3A2,2,0,0,0,1,5V17a2,2,0,0,0,2,2H21a2,2,0,0,0,2-2V5A2,2,0,0,0,21,3Zm0,2V17H3V5"></path>
      <rect x="5" y="12" width="11" height="2"></rect>
      <rect x="5" y="8" width="11" height="2"></rect>
      <rect x="17" y="8" width="2" height="2"></rect>
      <rect x="17" y="12" width="2" height="2"></rect></svg></md-icon>
        ...
        <!--?lit$111755957$--><mwc-icon-button command="show-terminal" title="Terminal"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="Terminal"><!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <span><slot></slot></span>
  </button></template>
          <md-icon aria-hidden="true"><template shadowrootmode="open"><!----><slot></slot></template><!--?lit$111755957$-->terminal</md-icon>
        </mwc-icon-button> <!--?lit$111755957$-->
      </div></div>
      </div></colab-left-pane>
        <div class="layout vertical grow">
          <colab-notebook-toolbar id="top-toolbar" class="horizontal layout center noshrink"><!----> <!--?lit$111755957$-->
...
paper-ripple {
  color: var(--paper-button-ink-color);
        ...
        <!--?lit$111755957$--><iron-icon icon="icons:add"><template shadowrootmode="open"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></g></svg><style scope="iron-icon">:host {
  display: var(--layout-inline_-_display);
        -ms-flex-align: var(--layout-center-center_-_-ms-flex-align); -webkit-align-items: var(--layout-center-center_-_-webkit-align-items); align-items: var(--layout-center-center_-_align-items); -ms-flex-pack: var(--layout-center-center_-_-ms-flex-pack); -webkit-justify-content: var(--layout-center-center_-_-webkit-justify-content); justify-content: var(--layout-center-center_-_justify-content);
        position: relative;
...
:host([hidden]) {
  display: none;
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="tooltip" message="Aşağıya kod hücresi ekle" shortcut="Ctrl+M B"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Aşağıya kod hücresi ekle</div><!----><!--?--></template>
      </colab-tooltip-trigger>
    </template>
            <!--?lit$111755957$-->Kod
...
:host([hidden]) {
  display: none;
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="tooltip" message="Metin hücresi ekle" shortcut=""><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Metin hücresi ekle</div><!----><!--?--></template>
      </colab-tooltip-trigger>
    </template>
            <!--?lit$111755957$-->Metin
          </colab-toolbar-button>
    ...
    <!--?lit$111755957$-->
    <!--?lit$111755957$-->
    <!--?lit$111755957$--> <span class="collapsed-options">
    ...
    <!--?lit$111755957$--><colab-connect-warning-button><template shadowrootmode="open"><!----><!--?lit$111755957$--><!--?--><!--?--></template></colab-connect-warning-button>
    <!--?lit$111755957$--> <colab-connect-button><template shadowrootmode="open"><!----> <!--?lit$111755957$--><!--?-->
...
paper-ripple {
  color: var(--paper-button-ink-color);
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="colab-connect-tooltip" message="Yeni bir çalışma zamanına bağlan
          ...
          " shortcut=""><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Yeni bir çalışma zamanına bağlan</div><!----><!----><div><!--?lit$111755957$--></div><!----><!----><div><!--?lit$111755957$-->          </div><!----><!--?--></template>
      </colab-tooltip-trigger>
    </template>
        <!--?lit$111755957$-->Bağlan
      </colab-toolbar-button>
      <!--?lit$111755957$--> <colab-toolbar-button id="connect-dropdown" class="icon-error" label="Diğer bağlantı seçenekleri" tooltiptext="Diğer bağlantı seçenekleri"><template shadowrootmode="open"><!---->
...
paper-ripple {
  color: var(--paper-button-ink-color);
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="tooltip" message="Diğer bağlantı seçenekleri" shortcut=""><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Diğer bağlantı seçenekleri</div><!----><!--?--></template>
      </colab-tooltip-trigger>
    </template>
...
:host([hidden]) {
  display: none;
    ...
    <!--?lit$111755957$--> <span class="colab-separator"></span>
...
paper-ripple {
  color: var(--paper-button-ink-color);
        ...
        <!--?lit$111755957$--><iron-icon icon="colab:supervised_user_circle"><template shadowrootmode="open"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g>
      <!--?lit$111755957$--><svg viewBox="0 0 24 24"><!--?lit$111755957$-->
      <path d="M 9.9582499,21.35987 C 10.842594,19.382021 12.606506,17.817985 14.716516,17.279566 16.41989,16.686126 18.317872,16.656934 20.03281,17.22182 22.44796,13.614773 22.030038,8.3464205 18.90388,5.2829204 15.571823,1.7178775 9.420202,1.3974701 5.769982,4.6587762 3.3377473,6.6864955 2.0387092,9.9509867 2.4603251,13.095093 c 0.1463132,1.333314 0.5764246,2.646122 1.3212592,3.766896 2.6970808,-1.363945 5.949002,-1.659216 8.8152407,-0.659689 -1.241623,0.378685 -1.898774,2.052201 -3.36112,1.793886 -1.3568211,-0.0051 -2.7332571,0.237474 -3.9549301,0.844871 1.267179,1.273083 2.9115843,2.175024 4.677475,2.518813 z m 2.0388991,2.638757 C 6.6511222,24.107652 1.5826283,20.137336 0.35384605,14.940954 -0.87900818,10.201889 1.1156845,4.8167637 5.2106158,2.1027623 9.1389196,-0.63068336 14.72247,-0.71788883 18.666809,2.0315664 c 3.770731,2.4797903 5.923366,7.1940181 5.205845,11.6657356 -0.561363,4.25325 -3.592409,8.039095 -7.614261,9.524313 -1.356179,0.518542 -2.808321,0.792183 -4.261244,0.777012 z M 8.9987675,13.80343 C 6.3557134,13.92683 4.1587181,11.059046 4.9242904,8.5324696 5.5067387,6.0598075 8.5843425,4.6198007 10.844905,5.8135307 c 2.251036,1.0498371 3.121931,4.2263483 1.586973,6.2196153 -0.777226,1.086407 -2.083619,1.810868 -3.4331105,1.770284 z m 0,-2.39887 C 10.82036,11.536018 11.503688,8.682573 9.8022883,7.9757151 8.3387516,7.206114 6.5439498,8.9550798 7.3889517,10.413062 c 0.2986856,0.592673 0.9351214,1.021277 1.6098158,0.991498 z m 8.3954675,3.598305 c -2.036107,0.118847 -3.612999,-2.238286 -2.81499,-4.095085 0.678013,-1.9105614 3.4227,-2.5652777 4.869242,-1.1247834 1.400594,1.2764214 1.220774,3.8379454 -0.469812,4.7846484 -0.472701,0.291047 -1.028762,0.44763 -1.58444,0.43522 z"></path></svg>
...
:host([hidden]) {
  display: none;
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="tooltip" message="" shortcut=""><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$--></div><!----><!--?--></template>
      </colab-tooltip-trigger>
    </template>
            <!--?lit$111755957$-->Colab AI
          </colab-toolbar-button>
    <!--?lit$111755957$-->
    <span class="collapsed-options">
      <!--?lit$111755957$--><span class="colab-separator"></span>
      <!--?lit$111755957$--> <paper-icon-button command="share" icon="social:people" alt="Not defterini paylaş" role="button" tabindex="0" aria-disabled="false" aria-label="Not defterini paylaş"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
:host([hidden]) {
  display: none;
    ...
    </paper-icon-button><colab-tooltip-trigger aria-hidden="true" for="toggle-header-button" id="toggle-header-button-tooltip"><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$-->Başlık görünürlüğünü aç/kapat</div><!----><!--?--></template>
      ...
      <!--?lit$111755957$--> <div class="layout vertical tab-pane-parent">
      <!--?lit$111755957$--><colab-tab-pane class="layout vertical grow no-header focused" align="horizontal"><!----> <div class="layout vertical grow">
...
:host([hidden]) {
  display: none;
      ...
      <paper-tab noink="" title="" aria-labelledby="tab-title-zDZyE440AUQX" class="iron-selected" role="tab" aria-disabled="false" aria-selected="true" tabindex="0"><template shadowrootmode="open"><style scope="paper-tab">:host {
  display: var(--layout-inline_-_display);
        -ms-flex-align: var(--layout-center_-_-ms-flex-align); -webkit-align-items: var(--layout-center_-_-webkit-align-items); align-items: var(--layout-center_-_align-items);
    ...
    <div class="tab-content">
      <slot></slot>
          ...
          <div class="colab-tab-header">
            <span class="colab-tab-title" id="tab-title-zDZyE440AUQX"><!--?lit$111755957$--><!--?lit$111755957$-->Not Defteri<!--?--></span>
            <!--?lit$111755957$-->
          </div>
        </paper-tab></paper-tabs>
      <!--?lit$111755957$--> <paper-icon-button icon="icons:more-horiz" title="Daha fazla göster" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
          ...
          <div class="notebook-scrolling-horizontal">
            <div class="notebook-content-background">
              ...
              <div class="notebook-content ">
                <!--?lit$111755957$--><div class="add-cell">
  ...
  display: none;
      ...
      <colab-tooltip-trigger for="button" offset="7" aria-hidden="true" id="tooltip" message="" shortcut=""><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----><div><!--?lit$111755957$--></div><!----><!--?--></template>
        ...
        <!--?lit$111755957$-->
                ...
                <div class="notebook-cell-list"><div class="cell code code-has-output icon-scrolling focused" id="cell--n8lRqAYK7Zk" tabindex="-1" role="region" aria-label="Hücre 0: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"><colab-cell-toolbar><template shadowrootmode="open"><!----><!--?lit$111755957$--><!----> <paper-icon-button class="colab-icon" noink="" icon="icons:arrow-upward" title="Hücreyi yukarı taşı
...
:host([hidden]) {
  display: none;
        ...
        </paper-icon-button><!----><!--?lit$111755957$--><paper-icon-button noink="" icon="icons:more-vert" title="Diğer hücre işlemleri" class="colab-icon cell-toolbar-more" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
16:26 (22 saat önce)
0.016 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution focused stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
...
yürütme, Berru Ateş tarafından gerçekleştirildi
16:26 (22 saat önce)
0.016 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          </mwc-icon-button><!--?--></template></colab-output-info></div>
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>...PYTHON EĞTİMLERİ...
        *
       ***
      *****
     *******
...
yürütme, Berru Ateş tarafından gerçekleştirildi
16:52 (21 saat önce)
8.751 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
...
yürütme, Berru Ateş tarafından gerçekleştirildi
16:52 (21 saat önce)
8.751 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>Requirement already satisfied: requests in /usr/local/lib/python3.10/dist-packages (2.31.0)
...
Requirement already satisfied: certifi&gt;=2017.4.17 in /usr/local/lib/python3.10/dist-packages (from requests) (2023.11.17)
      ...
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-6P1K3_rZW2UL" tabindex="-1" role="region" aria-label="Hücre 2: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:06 (20 saat önce)
2.497 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;random</span></span><br><span><span class="mtk1">random_oyun&nbsp;=&nbsp;random.randint(</span><span class="mtk12">1</span><span class="mtk1">,&nbsp;</span><span class="mtk12">50</span><span class="mtk1">)</span></span><br><span><span class="mtk1">kullanıcı=</span><span class="mtk14">int</span><span class="mtk1">(</span><span class="mtk15">input</span><span class="mtk1">(</span><span class="mtk26">"1&nbsp;ile&nbsp;50&nbsp;arasında&nbsp;sayıyı&nbsp;tahmin&nbsp;ediniz"</span><span class="mtk1">))</span></span><br><span><span class="mtk19">if</span><span class="mtk1">&nbsp;(kullanıcı&gt;random_oyun):</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"daha&nbsp;küçük&nbsp;sayı&nbsp;giriniz"</span><span class="mtk1">)</span></span><br><span><span class="mtk19">if</span><span class="mtk1">&nbsp;kullanıcı&nbsp;==&nbsp;random_oyun:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk19">if</span><span class="mtk1">&nbsp;(kullanıcı&lt;random_oyun):</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"daha&nbsp;büyük&nbsp;sayı&nbsp;giriniz"</span><span class="mtk1">)</span></span><br><span><span class="mtk19">if</span><span class="mtk1">&nbsp;kullanıcı&nbsp;==&nbsp;random_oyun:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Tebrikler,&nbsp;doğru&nbsp;sayıyı&nbsp;tahmin&nbsp;ettiniz!"</span><span class="mtk1">)</span></span><br><span><span class="mtk19">else</span><span class="mtk1">:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Tebrikler,&nbsp;doğru&nbsp;sayıyı&nbsp;tahmin&nbsp;ettiniz!"</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:06 (20 saat önce)
2.497 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>1 ile 50 arasında sayıyı tahmin ediniz6
Tebrikler, doğru sayıyı tahmin ettiniz!
</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-KhGfxwLUn-HA" tabindex="-1" role="region" aria-label="Hücre 3: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:21 (20 saat önce)
49.454 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;random&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;randint</span></span><br><span><span class="mtk1">tahmin&nbsp;=randint(</span><span class="mtk12">1</span><span class="mtk1">,&nbsp;</span><span class="mtk12">58</span><span class="mtk1">)</span></span><br><span><span class="mtk1">sayac=</span><span class="mtk12">0</span></span><br><span><span class="mtk1">dogrutahmin=</span><span class="mtk6">False</span></span><br><span><span class="mtk19">while</span><span class="mtk1">&nbsp;(dogrutahmin==</span><span class="mtk6">False</span><span class="mtk1">):</span></span><br><span><span class="mtk1">&nbsp;&nbsp;sayac+=</span><span class="mtk12">1</span></span><br><span><span class="mtk1">&nbsp;&nbsp;girilensayi=</span><span class="mtk14">int</span><span class="mtk1">(</span><span class="mtk15">input</span><span class="mtk1">(</span><span class="mtk26">"1&nbsp;ile&nbsp;50&nbsp;arasında&nbsp;sayı&nbsp;giriniz:&nbsp;(cıkmak&nbsp;için&nbsp;</span><span class="mtk26">sıfıra&nbsp;basın)"</span><span class="mtk1">))</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk19">if</span><span class="mtk1">(girilensayi==</span><span class="mtk12">0</span><span class="mtk1">):</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"oyundan&nbsp;çıktınz"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk19">break</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk19">elif</span><span class="mtk1">&nbsp;girilensayi&nbsp;&lt;&nbsp;tahmin:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Dusük&nbsp;sayı&nbsp;girişi&nbsp;yaptınız.&nbsp;Daha&nbsp;yüksek&nbsp;sayı&nbsp;</span><span class="mtk26">giriniz"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk19">continue</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk19">elif</span><span class="mtk1">&nbsp;girilensayi&nbsp;&gt;&nbsp;tahmin:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Yuksek&nbsp;sayı&nbsp;girişi&nbsp;yaptınız.&nbsp;Daha&nbsp;düşük&nbsp;bir&nbsp;sayı&nbsp;</span><span class="mtk26">giriniz"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk19">continue</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk19">else</span><span class="mtk1">:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dogrutahmin=</span><span class="mtk6">True</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Doğru&nbsp;tahmin.&nbsp;Rastgele&nbsp;Tahmin&nbsp;Edilen&nbsp;Saya()"</span><span class="mtk1">.</span><span class="mtk15">format</span><span class="mtk1">(tahmin))</span></span><br><span><span class="mtk1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"tahmin&nbsp;sayınız{}"</span><span class="mtk1">.</span><span class="mtk15">format</span><span class="mtk1">(sayac))</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:21 (20 saat önce)
49.454 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style=""><div class="outputview" style="height: 652px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe.html" class="" style="height: 652px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code icon-scrolling" id="cell-K-VCtqsKqnO4" tabindex="-1" role="region" aria-label="Hücre 4: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;random&nbsp;</span><span class="mtk19">as</span><span class="mtk1">&nbsp;rd</span></span><br><span><span class="mtk1">rastgele=rd.randint(</span><span class="mtk12">1</span><span class="mtk1">,</span><span class="mtk12">50</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
...
:host([hidden]) {
  display: none;
    ...
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-z2jFFfplrD2W" tabindex="-1" role="region" aria-label="Hücre 5: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:25 (20 saat önce)
0.308 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;math</span></span><br><span><span class="mtk1">math.sqrt(</span><span class="mtk12">9</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:25 (20 saat önce)
0.308 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>3.0</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-Rly2b9TDrS5O" tabindex="-1" role="region" aria-label="Hücre 6: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:25 (20 saat önce)
0.292 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk1">math.</span><span class="mtk15">pow</span><span class="mtk1">(</span><span class="mtk12">2</span><span class="mtk1">,</span><span class="mtk12">3</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:25 (20 saat önce)
0.292 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>8.0</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <div class="add-cell-buttons">
        <colab-toolbar-button class="add-code add-button" icon="icons:add" title="Kod hücresi ekle
...
:host([hidden]) {
  display: none;
    ...
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-zzKGMnqBrVz2" tabindex="-1" role="region" aria-label="Hücre 7: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:26 (20 saat önce)
0.264 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk1">math.factorial(</span><span class="mtk12">5</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:26 (20 saat önce)
0.264 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>120</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-jbWAJ9evreAA" tabindex="-1" role="region" aria-label="Hücre 8: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:26 (20 saat önce)
0.289 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk1">math.pi</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:26 (20 saat önce)
0.289 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>3.141592653589793</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <div class="add-cell-buttons">
        <colab-toolbar-button class="add-code add-button" icon="icons:add" title="Kod hücresi ekle
...
:host([hidden]) {
  display: none;
    ...
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-QCbB6dR1sFYY" tabindex="-1" role="region" aria-label="Hücre 9: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.31 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;datetime&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;date</span></span><br><span><span class="mtk1">tarih=date.today()</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(tarih)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.31 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>2024-01-28
</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-v68fdKFxsWG2" tabindex="-1" role="region" aria-label="Hücre 10: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.321 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab colab" data-lang="notebook-python"><span><span class="mtk1">tarih.year</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.321 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>2024</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-3vSRVjF_saZf" tabindex="-1" role="region" aria-label="Hücre 11: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.293 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk1">tarih.month</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:30 (20 saat önce)
0.293 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>1</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <div class="add-cell-buttons">
        <colab-toolbar-button class="add-code add-button" icon="icons:add" title="Kod hücresi ekle
...
:host([hidden]) {
  display: none;
    ...
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-1INkUNJ2se1q" tabindex="-1" role="region" aria-label="Hücre 12: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:32 (20 saat önce)
0.286 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution stale">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;datetime&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;time</span></span><br><span><span class="mtk1">saat=time(</span><span class="mtk12">10</span><span class="mtk1">,</span><span class="mtk12">20</span><span class="mtk1">,</span><span class="mtk12">30</span><span class="mtk1">,</span><span class="mtk12">245</span><span class="mtk1">)</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(saat)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:32 (20 saat önce)
0.286 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>10:20:30.000245
</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-6RrhE-ITs3Tu" tabindex="-1" role="region" aria-label="Hücre 13: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:33 (20 saat önce)
0.287 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;datetime</span></span><br><span><span class="mtk1">datetime.datetime.now()</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:33 (20 saat önce)
0.287 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="execute_result output_text"><pre>datetime.datetime(2024, 1, 28, 15, 33, 30, 776277)</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-GXseJIk7tZyt" tabindex="-1" role="region" aria-label="Hücre 14: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:36 (19 saat önce)
0.283 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab colab" data-lang="notebook-python"><span><span class="mtk1">zaman1=date(</span><span class="mtk12">2024</span><span class="mtk1">,</span><span class="mtk12">1</span><span class="mtk1">,</span><span class="mtk12">28</span><span class="mtk1">)</span></span><br><span><span class="mtk1">zaman2=date(</span><span class="mtk12">2023</span><span class="mtk1">,</span><span class="mtk12">2</span><span class="mtk1">,</span><span class="mtk12">6</span><span class="mtk1">)</span></span><br><span><span class="mtk1">fark=zaman1-zaman2</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(fark)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:36 (19 saat önce)
0.283 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>356 days, 0:00:00
</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-YN3SlfUCuVpY" tabindex="-1" role="region" aria-label="Hücre 15: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:43 (19 saat önce)
0.007 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk1">bugün=&nbsp;datetime.datetime.today()</span></span><br><span><span class="mtk1">fark&nbsp;=&nbsp;datetime.timedelta(days=</span><span class="mtk12">200</span><span class="mtk1">)</span></span><br><span><span class="mtk1">fark&nbsp;=&nbsp;datetime.timedelta(days=</span><span class="mtk12">200</span><span class="mtk1">,&nbsp;seconds=</span><span class="mtk12">40</span><span class="mtk1">,&nbsp;microseconds=</span><span class="mtk12">30</span><span class="mtk1">)</span></span><br><span><span class="mtk1">gelecek=&nbsp;bugün&nbsp;+&nbsp;fark</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(gelecek)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:43 (19 saat önce)
0.007 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>2024-08-15 15:44:12.455879
</pre></div></div><div></div></colab-static-output-renderer></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-2i4y16sEveFu" tabindex="-1" role="region" aria-label="Hücre 16: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk1">gelecek=&nbsp;bugün&nbsp;+&nbsp;fark</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(gelecek)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
0.31 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
    ...
    <span><slot></slot></span>
      ...
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-QGyJnDrNvtU5" tabindex="-1" role="region" aria-label="Hücre 17: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:52 (19 saat önce)
20.765 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;datetime&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;datetime</span></span><br><span><span class="mtk1">tarihler&nbsp;=&nbsp;</span><span class="mtk15">input</span><span class="mtk1">(</span><span class="mtk26">"Lütfen&nbsp;bir&nbsp;tarih&nbsp;giriniz&nbsp;(gün.ay.yıl):&nbsp;"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">tarih&nbsp;=&nbsp;datetime.strptime(</span><span class="mtk26">"%d.&nbsp;%m.&nbsp;%y"</span><span class="mtk1">)</span></span><br><span><span></span></span><br><span><span class="mtk1">gun&nbsp;=&nbsp;tarih.day</span></span><br><span><span class="mtk1">ay&nbsp;=&nbsp;tarih.month</span></span><br><span><span class="mtk1">yil&nbsp;=&nbsp;tarih.year</span></span><br><span><span></span></span><br><span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Gün:"</span><span class="mtk1">,&nbsp;gun)</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Ay:"</span><span class="mtk1">,&nbsp;ay)</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Yıl:"</span><span class="mtk1">,&nbsp;yil)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
18:52 (19 saat önce)
20.765 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style="height: 273px;"><div class="outputview" style="height: 263px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(1).html" class="" style="height: 263px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-6OGbS0ANx4FI" tabindex="-1" role="region" aria-label="Hücre 18: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:09 (19 saat önce)
55.169 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;datetime&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;datetime</span></span><br><span><span class="mtk1">tarihler&nbsp;=&nbsp;</span><span class="mtk15">input</span><span class="mtk1">(</span><span class="mtk26">"Tarih&nbsp;(yyyy-aa-gg)&nbsp;formatında&nbsp;giriniz:&nbsp;"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">tarih&nbsp;=&nbsp;datetime.strptime(tarihler,&nbsp;</span><span class="mtk26">"%Y-%m-%d"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">gun&nbsp;=&nbsp;tarih.day</span></span><br><span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"Gün:"</span><span class="mtk1">,&nbsp;gun)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:09 (19 saat önce)
55.169 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style="height: 425px;"><div class="outputview" style="height: 409px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(2).html" class="" style="height: 409px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-ckV_hBZZ0Zqk" tabindex="-1" role="region" aria-label="Hücre 19: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:07 (19 saat önce)
0.296 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;datetime</span></span><br><span><span class="mtk1">an=datetime.datetime.now()</span></span><br><span><span class="mtk1">datetime.datetime.strftime(an,&nbsp;</span><span class="mtk26">'%X'</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:07 (19 saat önce)
0.296 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style="height: 36px;"><div class="outputview" style="height: 35px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(3).html" class="" style="height: 35px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-hgmGBZzK2DDG" tabindex="-1" role="region" aria-label="Hücre 20: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:18 (19 saat önce)
2.516 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk19">from</span><span class="mtk1">&nbsp;datetime&nbsp;</span><span class="mtk19">import</span><span class="mtk1">&nbsp;datetime</span></span><br><span><span class="mtk19">import</span><span class="mtk1">&nbsp;time</span></span><br><span><span></span></span><br><span><span class="mtk19">while</span><span class="mtk1">&nbsp;</span><span class="mtk6">True</span><span class="mtk1">:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;yerel_saat=time.localtime()</span></span><br><span><span class="mtk1">&nbsp;&nbsp;yenisaat&nbsp;=&nbsp;time.strftime(</span><span class="mtk26">"%H:%M:%S"</span><span class="mtk1">,&nbsp;yerel_saat)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(yenisaat)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;time.sleep(</span><span class="mtk12">1</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:18 (19 saat önce)
2.516 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style="height: 273px;"><div class="outputview" style="height: 263px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(4).html" class="" style="height: 263px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code code-has-output icon-scrolling" id="cell-h7rbI2hK3YYO" tabindex="-1" role="region" aria-label="Hücre 21: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:20 (19 saat önce)
17.071 saniyede yürütüldü" role="button" aria-label="Hücreyi çalıştır"><template shadowrootmode="open"><!----> <div class="cell-execution  stale ">
      <div class="execution-count"><!--?lit$111755957$-->[ ]</div>
      <div class="cell-execution-indicator"> <!--?lit$111755957$-->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <!--?lit$111755957$-->
  ...
  <circle cx="12" cy="12" r="7.8" mask="url(#playSymbolMask)" id="filledCircle"></circle>
      ...
      <div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk19">import</span><span class="mtk1">&nbsp;time</span></span><br><span><span class="mtk19">while</span><span class="mtk1">&nbsp;</span><span class="mtk6">True</span><span class="mtk1">:</span></span><br><span><span class="mtk1">&nbsp;&nbsp;</span><span class="mtk15">print</span><span class="mtk1">(</span><span class="mtk26">"suyunuzu&nbsp;içiniz"</span><span class="mtk1">)</span></span><br><span><span class="mtk1">&nbsp;&nbsp;time.sleep(</span><span class="mtk12">8</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div>
    <div class="output"><!----> <div class="output-header"> </div>
        <div class="output-content">
          <div class="output-info"><colab-output-info title="Çıkışı temizle
...
yürütme, Berru Ateş tarafından gerçekleştirildi
19:20 (19 saat önce)
17.071 saniyede yürütüldü"><template shadowrootmode="open"><!----> <mwc-icon class="collaborator output" alt="Yürütme çıkışı"><template shadowrootmode="open"><!----><span><slot></slot></span></template><!--?lit$111755957$-->output</mwc-icon>
      <!--?lit$111755957$--> <mwc-icon-button icon="cancel" command="clear-focused-or-selected-outputs" alt="Çıkışı temizle"><template shadowrootmode="open"><!----><button class="mdc-icon-button mdc-icon-button--display-flex" aria-label="cancel"><!--?lit$111755957$-->
    <!--?lit$111755957$--><i class="material-icons"><!--?lit$111755957$-->cancel</i>
    <span><slot></slot></span>
  </button></template>
          ...
          <div class="output-iframe-container">
            <div class="output-iframe-sizer"> <div style="height: 273px;"><div class="outputview" style="height: 263px;"><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(5).html" class="" style="height: 263px;"></iframe></div></div></div>
          </div>
        </div></div></div></div></div><div class="add-cell">
      <hr>
    </div></div><div class="cell code icon-scrolling" id="cell-If9QmVhR29vt" tabindex="-1" role="region" aria-label="Hücre 22: Kod hücresi: " style=""><div class="cell-tag-editor sticky"></div><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-contents"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output">
      <div class="inputarea horizontal layout code">
        <div class="cell-gutter">
          <!-- Bounding range for vertical scrolling of icons -->
          <div class="cell-execution-container">
...
<img draggable="false" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no" style="width: 100%; height: 100%;"></template>
              ...
              <div class="comment-author"><!--?lit$111755957$-->Berru Ateş</div>
              <div class="comment-date">
                <!--?lit$111755957$-->19:20 Dün
              </div>
              <div class="comment-date comment-modified-date" style="display: none;">(Düzenlenme zamanı: 19:20 Dün)</div>
            </div>
...
paper-ripple {
  color: var(--paper-button-ink-color);
}</style><slot></slot></template>Tekrar aç</paper-button><!--?lit$111755957$--><paper-icon-button icon="icons:more-vert" class="comment-action-dropdown" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
        padding: 8px;
        outline: none;
...
:host([hidden]) {
  display: none;
          ...
          <div class="comment-text-container">
            <div class="comment-text">doğru</div>
            <div class="comment-collapse-control comment-show-more" style="display: none;">
              <!--?lit$111755957$-->Daha fazla göster
            </div>
            <div class="comment-collapse-control comment-show-less" style="display: none;">
              <!--?lit$111755957$-->Daha az göster
            </div>
          </div>
        </div>
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5z" aria-controls=":5z" style="height: 5px;"></textarea>
      ...
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        ...
        <span class="mdc-button__label"><!--?lit$111755957$--></span>
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
          <a href="https://colab.research.google.com/drive/1Edm3snX_fmaSfw4L3ev9KwwuOAOT32HR#" class="show-more-replies" style="display: none;">0 yanıt daha göster...</a>
        </div>
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":60" aria-controls=":60" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
...
:host([hidden]) {
  display: none;
          ...
          <div class="comment-text-container">
            <div class="comment-text">zamanlayıcı</div>
            <div class="comment-collapse-control comment-show-more" style="display: none;">
              <!--?lit$111755957$-->Daha fazla göster
            </div>
            <div class="comment-collapse-control comment-show-less" style="display: none;">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":63" aria-controls=":63" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":64" aria-controls=":64" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":67" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":68" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwyw" style="top: 4706px;"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
<img draggable="false" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no" style="width: 100%; height: 100%;"></template>
              ...
              <div class="comment-author"><!--?lit$111755957$-->Berru Ateş</div>
              <div class="comment-date">
                <!--?lit$111755957$-->19:18 Dün
              </div>
              <div class="comment-date comment-modified-date" style="display: none;">(Düzenlenme zamanı: 19:18 Dün)</div>
            </div>
            <div class="comment-buttons"><paper-icon-button class="comment-action-button comment-resolve-button" role="button" tabindex="0" aria-disabled="false" style="display: block;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
...
:host([hidden]) {
  display: none;
          ...
          <div class="comment-text-container">
            <div class="comment-text">yanlışdeğil</div>
            <div class="comment-collapse-control comment-show-more" style="display: none;">
              <!--?lit$111755957$-->Daha fazla göster
            </div>
            <div class="comment-collapse-control comment-show-less" style="display: none;">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":67" aria-controls=":67" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":68" aria-controls=":68" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":6b" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":6c" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwys" style="top: 4603px;"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
<img draggable="false" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no" style="width: 100%; height: 100%;"></template>
              ...
              <div class="comment-author"><!--?lit$111755957$-->Berru Ateş</div>
              <div class="comment-date">
                <!--?lit$111755957$-->19:17 Dün
              </div>
              <div class="comment-date comment-modified-date" style="display: none;">(Düzenlenme zamanı: 19:17 Dün)</div>
            </div>
            <div class="comment-buttons"><paper-icon-button class="comment-action-button comment-resolve-button" role="button" tabindex="0" aria-disabled="false" style="display: block;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
...
:host([hidden]) {
  display: none;
          ...
          <div class="comment-text-container">
            <div class="comment-text">dijital saat</div>
            <div class="comment-collapse-control comment-show-more" style="display: none;">
              <!--?lit$111755957$-->Daha fazla göster
            </div>
            <div class="comment-collapse-control comment-show-less" style="display: none;">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":6b" aria-controls=":6b" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":6c" aria-controls=":6c" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":6f" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div peoplekit-id="nVhUhf" class="aU4VQc peoplekitThemeLight" jslog="64611; track:impression; cid:peoplekitweb"><div class="peoplekitComponentsAutocompletePopupContainer" peoplekit-id="noeiCf" style="display: none;" pkd-ps-state="2"><div class="peoplekitComponentsAutocompleteInlineContainer" peoplekit-id="yDHfq" jslog="85843; track:impression; cid:peoplekitweb" pkd-ac-state="0;"><div class="peoplekitComponentsAutocompleteInlineListContainer"><div tabindex="-1" class="peoplekitComponentsScrollboxScrollbar" peoplekit-id="I8ejUe"><div peoplekit-id="tjneg"><div peoplekit-id="aittld"><div peoplekit-id="tjneg"><ul id=":6g" peoplekit-id="rymPhb" role="listbox" aria-multiselectable="true" class="peoplekitComponentsListImplList" aria-labelledby=""></ul></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineCircularProgress"><div class="peoplekitComponentsCircularprogressCircularProgress isActive" data-loadingmessage="Loading..." data-active="true"><div class="peoplekitComponentsCircularprogressMessageContainer" aria-live="polite" jsname="vyyg5">Loading...</div><div class="peoplekitComponentsCircularprogressCircularProgressContainer"><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorOne exportColorOne"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorTwo exportColorTwo"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorThree exportColorThree"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div><div class="peoplekitComponentsCircularprogressCircularProgressLayer peoplekitComponentsCircularprogressColorFour exportColorFour"><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressLeft"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressGapPatch"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div><div class="peoplekitComponentsCircularprogressCircleClipper peoplekitComponentsCircularprogressRight"><div class="peoplekitComponentsCircularprogressCircle exportCircle"></div></div></div></div></div></div><div class="peoplekitComponentsAutocompleteInlineNoResultsContainer"></div></div></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwiI" style="top: 949px;"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
<img draggable="false" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no" style="width: 100%; height: 100%;"></template>
              ...
              <div class="comment-author"><!--?lit$111755957$-->Berru Ateş</div>
              <div class="comment-date">
                <!--?lit$111755957$-->18:22 Dün
              </div>
              <div class="comment-date comment-modified-date" style="display: none;">(Düzenlenme zamanı: 18:22 Dün)</div>
            </div>
            <div class="comment-buttons"><paper-icon-button class="comment-action-button comment-resolve-button" role="button" tabindex="0" aria-disabled="false" style="display: block;"><template shadowrootmode="open"><style scope="paper-icon-button">:host {
  display: inline-block;
        position: relative;
...
:host([hidden]) {
  display: none;
          ...
          <div class="comment-text-container">
            <div class="comment-text">yanlış değil</div>
            <div class="comment-collapse-control comment-show-more" style="display: none;">
              <!--?lit$111755957$-->Daha fazla göster
            </div>
            <div class="comment-collapse-control comment-show-less" style="display: none;">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":6f" aria-controls=":6f" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":6g" aria-controls=":6g" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        <span class="trailing-icon">
          ...
          <!--?lit$111755957$--> <div class="footer-links">
      <a target="_blank" href="https://colab.research.google.com/signup?utm_source=footer&amp;utm_medium=link&amp;utm_campaign=footer_links">
        <!--?lit$111755957$-->Colab'in ücretli ürünleri
      </a>
      -
      <a href="https://colab.research.google.com/cancel-subscription" target="_blank">
        <!--?lit$111755957$-->Sözleşmeleri buradan iptal edebilirsiniz
      </a>
    </div>
        </div>
      ...
      <colab-resizer style="height: 33.3%" class="sn-resize no-tabs"><div class="resizer-thumb"></div>
        <!--?lit$111755957$--><colab-tab-pane class="layout vertical grow no-tabs" align="horizontal"><!----> <div class="layout vertical grow">
    <div class="tab-pane-header layout horizontal noshrink">
      <paper-tabs selected="0" noink="" class="layout grow" scrollable="" role="tablist" tabindex="0" dir="null"><template shadowrootmode="open"><style scope="paper-tabs">:host {
  display: var(--layout_-_display);
        -ms-flex-align: var(--layout-center_-_-ms-flex-align); -webkit-align-items: var(--layout-center_-_-webkit-align-items); align-items: var(--layout-center_-_align-items);
...
:host([hidden]) {
  display: none;
    ...
    <div class="layout vertical grow tab-pane-container"> </div>
        ...
        <div class="proxies"><div><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(6).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div><div><colab-dom-lifecycle-events style="display: none;"></colab-dom-lifecycle-events><iframe allow="accelerometer; autoplay; camera; gyroscope; magnetometer; microphone; serial; usb; xr-spatial-tracking; clipboard-write" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-modals allow-popups-to-escape-sandbox" src="./yılbasıyıldızlı_files/outputframe(7).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div></div>
      <colab-file-viewer-manager></colab-file-viewer-manager></div>
    <colab-status-bar role="region" aria-label="Çalışma zamanı durum çubuğu" style="min-height: inherit;"><template shadowrootmode="open"><!----> <!--?lit$111755957$--><div class="frames"></div>
...
:host([hidden]) {
  display: none;
      ...
      </paper-icon-button></template></colab-status-bar></div><div class="goog-menu" id="file-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="locate-in-drive" class="goog-menuitem " role="menuitem" id=":2" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Drive'da bul<!--?lit$111755957$--></div></div><div command="open-in-playground" class="goog-menuitem " role="menuitem" id=":3" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Playground modunda aç<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":4" style="user-select: none;"></div><div command="new" class="goog-menuitem " role="menuitem" id=":5" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yeni not defteri<!--?lit$111755957$--></div></div><div command="open" class="goog-menuitem " role="menuitem" id=":6" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Not defterini aç<!--?lit$111755957$--></div></div><div command="import-notebook" class="goog-menuitem " role="menuitem" id=":7" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Not defteri yükle<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":8" style="user-select: none;"></div><div command="rename" class="goog-menuitem " role="menuitem" id=":9" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yeniden adlandır<!--?lit$111755957$--></div></div><div command="move-notebook" class="goog-menuitem " role="menuitem" id=":a" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Taşı<!--?lit$111755957$--></div></div><div command="trash" class="goog-menuitem " role="menuitem" id=":b" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Çöp kutusuna taşı<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":c" style="user-select: none;"></div><div command="clone" class="goog-menuitem " role="menuitem" id=":d" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Drive'da bir kopya kaydet<!--?lit$111755957$--></div></div><div command="copy-to-gist" class="goog-menuitem " role="menuitem" id=":e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->GitHub Gist olarak bir kopya kaydet<!--?lit$111755957$--></div></div><div command="copy-to-github" class="goog-menuitem " role="menuitem" id=":f" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->GitHub'da bir kopya kaydet<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":g" style="user-select: none;"></div><div command="save" class="goog-menuitem " role="menuitem" id=":h" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kaydet<!--?lit$111755957$--></div></div><div command="save-and-checkpoint" class="goog-menuitem " role="menuitem" id=":i" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Düzeltmeyi kaydet ve sabitle<!--?lit$111755957$--></div></div><div command="show-history" class="goog-menuitem " role="menuitem" id=":j" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Düzeltme geçmişi<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":k" style="user-select: none;"></div><div class="goog-submenu goog-menuitem" id="download-submenu-menu-button" role="menuitem" aria-haspopup="true" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;">
      <!--?lit$111755957$-->İndir
    <span class="goog-submenu-arrow" style="user-select: none;">►</span></div></div><div command="print" class="goog-menuitem " role="menuitem" id=":o" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yazdır<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="download-submenu-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="download-ipynb" class="goog-menuitem " role="menuitem" id=":m" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->.ipynb sürümünü indir<!--?lit$111755957$--></div></div><div command="download-python" class="goog-menuitem " role="menuitem" id=":n" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->.py indir<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="edit-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="undo" class="goog-menuitem " role="menuitem" id=":q" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Geri al<!--?lit$111755957$--></div></div><div command="redo" class="goog-menuitem " role="menuitem" id=":r" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yeniden yap<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":s" style="user-select: none;"></div><div command="select-all" class="goog-menuitem " role="menuitem" id=":t" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Tüm hücreleri seç<!--?lit$111755957$--></div></div><div command="cut" class="goog-menuitem " role="menuitem" id=":u" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Hücreyi veya seçimi kes<!--?lit$111755957$--></div></div><div command="copy" class="goog-menuitem " role="menuitem" id=":v" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Hücreyi veya seçimi kopyala<!--?lit$111755957$--></div></div><div command="paste" class="goog-menuitem " role="menuitem" id=":w" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yapıştır<!--?lit$111755957$--></div></div><div command="delete-cell-or-selection" class="goog-menuitem " role="menuitem" id=":x" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Seçilen hücreleri sil<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":y" style="user-select: none;"></div><div command="find" class="goog-menuitem " role="menuitem" id=":z" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Bul ve değiştir<!--?lit$111755957$--></div></div><div command="find-next" class="goog-menuitem " role="menuitem" id=":10" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sonrakini bul<!--?lit$111755957$--></div></div><div command="find-previous" class="goog-menuitem " role="menuitem" id=":11" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Öncekini bul<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":12" style="user-select: none;"></div><div command="notebook-settings" class="goog-menuitem " role="menuitem" id=":13" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Not defteri ayarları<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":14" style="user-select: none;"></div><div command="clear-outputs" class="goog-menuitem " role="menuitem" id=":15" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Tüm çıkışları temizle<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="view-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="show-toc-pane" class="goog-menuitem goog-option" role="menuitemcheckbox" aria-checked="false" id=":17" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><div class="goog-menuitem-checkbox" style="user-select: none;"><iron-icon><template shadowrootmode="open"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path></g></svg><style scope="iron-icon">:host {
  display: var(--layout-inline_-_display);
        -ms-flex-align: var(--layout-center-center_-_-ms-flex-align); -webkit-align-items: var(--layout-center-center_-_-webkit-align-items); align-items: var(--layout-center-center_-_align-items); -ms-flex-pack: var(--layout-center-center_-_-ms-flex-pack); -webkit-justify-content: var(--layout-center-center_-_-webkit-justify-content); justify-content: var(--layout-center-center_-_justify-content);
        position: relative;
...
</template></iron-icon></div><!--?lit$111755957$-->İçindekiler<!--?lit$111755957$--></div></div><div command="show-fileinfo" class="goog-menuitem " role="menuitem" id=":18" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Not defteri hakkında bilgi<!--?lit$111755957$--></div></div><div command="show-executedcode" class="goog-menuitem " role="menuitem" id=":19" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yürütülen kod geçmişi<!--?lit$111755957$--></div></div><div command="toggle-comments-visibility" class="goog-menuitem goog-option" role="menuitemcheckbox" aria-checked="false" id=":1a" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><div class="goog-menuitem-checkbox" style="user-select: none;"><iron-icon><template shadowrootmode="open"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path></g></svg><style scope="iron-icon">:host {
  display: var(--layout-inline_-_display);
        -ms-flex-align: var(--layout-center-center_-_-ms-flex-align); -webkit-align-items: var(--layout-center-center_-_-webkit-align-items); align-items: var(--layout-center-center_-_align-items); -ms-flex-pack: var(--layout-center-center_-_-ms-flex-pack); -webkit-justify-content: var(--layout-center-center_-_-webkit-justify-content); justify-content: var(--layout-center-center_-_justify-content);
        position: relative;
...
</template></iron-icon></div><!--?lit$111755957$-->Yorumlar kenar çubuğu<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1b" style="user-select: none;"></div><div command="collapse-sections" class="goog-menuitem " role="menuitem" id=":1c" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Bölümleri daralt<!--?lit$111755957$--></div></div><div command="expand-sections" class="goog-menuitem " role="menuitem" id=":1d" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Bölümleri genişlet<!--?lit$111755957$--></div></div><div command="save-section-layout" class="goog-menuitem " role="menuitem" id=":1e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Daraltılmış bölüm düzenini kaydet<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1f" style="user-select: none;"></div><div command="hide-code" class="goog-menuitem " role="menuitem" id=":1g" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kodu göster/gizle<!--?lit$111755957$--></div></div><div command="toggle-output" class="goog-menuitem " role="menuitem" id=":1h" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Çıkışı göster/gizle<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1i" style="user-select: none;"></div><div command="focus-next-tab" class="goog-menuitem " role="menuitem" id=":1j" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sonraki sekmeye odaklan<!--?lit$111755957$--></div></div><div command="focus-previous-tab" class="goog-menuitem " role="menuitem" id=":1k" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Önceki sekmeye odaklan<!--?lit$111755957$--></div></div><div command="move-tab-to-next" class="goog-menuitem " role="menuitem" id=":1l" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sekmeyi sonraki bölmeye taşı<!--?lit$111755957$--></div></div><div command="move-tab-to-prev" class="goog-menuitem " role="menuitem" id=":1m" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sekmeyi önceki bölmeye taşı<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="insert-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="insert-cell-below" class="goog-menuitem " role="menuitem" id=":1o" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kod hücresi<!--?lit$111755957$--></div></div><div command="add-text" class="goog-menuitem " role="menuitem" id=":1p" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Metin hücresi<!--?lit$111755957$--></div></div><div command="add-section-header" class="goog-menuitem " role="menuitem" id=":1q" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Bölüm başlığı hücresi<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1r" style="user-select: none;"></div><div command="open-scratch-code-cell" class="goog-menuitem " role="menuitem" id=":1s" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Scratchpad kod hücresi<!--?lit$111755957$--></div></div><div command="snippets" class="goog-menuitem " role="menuitem" id=":1t" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kod snippet'leri<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1u" style="user-select: none;"></div><div command="add-form-field" class="goog-menuitem " role="menuitem" id=":1v" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Bir form alanı ekle<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="runtime-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="runall" class="goog-menuitem " role="menuitem" id=":1x" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Tümünü çalıştır<!--?lit$111755957$--></div></div><div command="runbefore" class="goog-menuitem " role="menuitem" id=":1y" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Şundan öncekileri çalıştır:<!--?lit$111755957$--></div></div><div command="runfocused" class="goog-menuitem " role="menuitem" id=":1z" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Odaklanılan hücreyi çalıştır<!--?lit$111755957$--></div></div><div command="runselected" class="goog-menuitem " role="menuitem" id=":20" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Seçimi çalıştır<!--?lit$111755957$--></div></div><div command="runafter" class="goog-menuitem " role="menuitem" id=":21" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Şundan sonrakileri çalıştır:<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":22" style="user-select: none;"></div><div command="interrupt" class="goog-menuitem " role="menuitem" id=":23" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Yürütmeyi kes<!--?lit$111755957$--></div></div><div command="restart" class="goog-menuitem " role="menuitem" id=":24" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Oturumu yeniden başlat<!--?lit$111755957$--></div></div><div command="restart-and-run-all" class="goog-menuitem " role="menuitem" id=":25" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Oturumu yeniden başlat ve tümünü çalıştır<!--?lit$111755957$--></div></div><div command="powerwash-current-vm" class="goog-menuitem " role="menuitem" id=":26" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Çalışma zamanı bağlantısını kes ve sil<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":27" style="user-select: none;"></div><div command="change-runtime-type" class="goog-menuitem " role="menuitem" id=":28" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Çalışma zamanı türünü değiştir<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":29" style="user-select: none;"></div><div command="manage-sessions" class="goog-menuitem " role="menuitem" id=":2a" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Oturumları yönet<!--?lit$111755957$--></div></div><div command="open-resource-viewer" class="goog-menuitem " role="menuitem" id=":2b" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kaynakları göster<!--?lit$111755957$--></div></div><div command="view-runtime-logs" class="goog-menuitem " role="menuitem" id=":2c" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Çalışma zamanı günlüklerini görüntüle<!--?lit$111755957$--></div></div></div><div class="goog-menu" id="tools-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="show-command-palette" class="goog-menuitem " role="menuitem" id=":2e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Komut paleti<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2f" style="user-select: none;"></div><div command="preferences" class="goog-menuitem " role="menuitem" id=":2g" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Ayarlar<!--?lit$111755957$--></div></div><div command="shortcuts" class="goog-menuitem " role="menuitem" id=":2h" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Klavye kısayolları<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2i" style="user-select: none;"></div><div command="open-differ" class="goog-menuitem " role="menuitem" id=":2j" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Not defterlerinin farkları<!--?lit$111755957$--> <span class="screenreader-only" style="user-select: none;"><!--?lit$111755957$-->(yeni bir sekmede açılır)</span></div></div></div><div class="goog-menu" id="help-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$111755957$--><div command="faq" class="goog-menuitem " role="menuitem" id=":2l" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sık sorulan sorular<!--?lit$111755957$--></div></div><div command="view-relnotes" class="goog-menuitem " role="menuitem" id=":2m" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Sürüm notlarını göster<!--?lit$111755957$--></div></div><div command="snippets" class="goog-menuitem " role="menuitem" id=":2n" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Kod snippet'i ara<!--?lit$111755957$--></div></div><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2o" style="user-select: none;"></div><div command="report-bug" class="goog-menuitem " role="menuitem" id=":2p" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Hata bildir<!--?lit$111755957$--></div></div><div command="report-abuse" class="goog-menuitem " role="menuitem" id=":2q" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Drive'da kötüye kullanımını bildirme<!--?lit$111755957$--></div></div><div command="send-feedback" class="goog-menuitem " role="menuitem" id=":2r" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->Geri bildirim<!--?lit$111755957$--></div></div><div command="view-in-english" class="goog-menuitem " role="menuitem" id=":2s" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$111755957$-->İngilizce olarak görüntüle<!--?lit$111755957$--></div></div></div><div class="doc-comments-area has-comments" style="display: none;"><!----><div class="doc-comments-buttons">
...
:host([hidden]) {
  display: none;
          ...
          <!--?lit$111755957$-->Yorum ekle
        </paper-button>
      </div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwy4"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
:host([hidden]) {
  display: none;
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5f" aria-controls=":5f" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5g" aria-controls=":5g" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwy0"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
:host([hidden]) {
  display: none;
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5i" aria-controls=":5i" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5j" aria-controls=":5j" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwyw"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
:host([hidden]) {
  display: none;
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5l" aria-controls=":5l" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5m" aria-controls=":5m" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwys"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
:host([hidden]) {
  display: none;
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5o" aria-controls=":5o" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5p" aria-controls=":5p" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div><div class="comment-fragment in-drive comment" comment-id="AAAA-7LLwiI"><!---->
        <div class="comment-content">
          <div class="comment-header">
            <div class="comment-author-info-container">
              <!--?lit$111755957$--><iron-icon class="comment-image" src="https://lh3.googleusercontent.com/a/ACg8ocLIgj_lePEl_GElM2zcVafJXozrobYo_GvyIpsJik2MHu4=s50-c-k-no"><template shadowrootmode="open"><style scope="iron-icon">:host {
...
:host([hidden]) {
  display: none;
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yorum yapın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5r" aria-controls=":5r" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <div class="reply-chain"><!----> <div class="reply-chain-content">
        ...
        <!--?lit$111755957$--><colab-comment-input class="comment-input text-empty"><!----> <!--?lit$111755957$--><textarea placeholder="@ ile yanıtlayın veya diğer kullanıcıları ekleyin" class="comment-input-text" aria-owns=":5s" aria-controls=":5s" style="height: 5px;"></textarea>
        <div class="bottom-buttons">
          <mwc-button dense="" unelevated="" disabled="" class="submit-button" title="Yorumu gönder"><template shadowrootmode="open"><!---->
      <button id="button" class="mdc-button  mdc-button--unelevated mdc-button--dense " disabled="" aria-label="">
        <!--?lit$111755957$--><!--?-->
      ...
      <button id="button" class="mdc-button  mdc-button--outlined mdc-button--dense " aria-label="">
        ...
        </div></colab-comment-input><!--?--></div></div></div><div class="thumbnail"></div><div class="monaco-aria-container"><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div></div><iframe id="apiproxy5eb495b9718564b9494d5eb929c80d6b1c2fedff0.2964088378" name="apiproxy5eb495b9718564b9494d5eb929c80d6b1c2fedff0.2964088378" src="./yılbasıyıldızlı_files/proxy.html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px; display: none;"></iframe><iframe id="apiproxyb66848ecd7c3e55eb861f491bca2131c05cb76220.48581097" name="apiproxyb66848ecd7c3e55eb861f491bca2131c05cb76220.48581097" src="./yılbasıyıldızlı_files/proxy(1).html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px; display: none;"></iframe><iframe src="./yılbasıyıldızlı_files/bscframe.html" style="display: none;"></iframe><div><div class="grecaptcha-badge" data-style="bottomright" style="width: 256px; height: 60px; position: fixed; visibility: hidden; display: block; transition: right 0.3s ease 0s; bottom: 14px; right: -186px; box-shadow: gray 0px 0px 5px; border-radius: 2px; overflow: hidden;"><div class="grecaptcha-logo"><iframe title="reCAPTCHA" width="256" height="60" role="presentation" name="a-hg5oaelt5ui6" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="./yılbasıyıldızlı_files/anchor.html"></iframe></div><div class="grecaptcha-error"></div><textarea id="g-recaptcha-response-100000" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./yılbasıyıldızlı_files/saved_resource.html"></iframe></div></body></html>